<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Laboratorio.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <!-- /.modal -->
        ...
        <form runat="server">
            <asp:GridView ID="GVLaboratorio" runat="server" CellPadding="4" CssClass="table" ForeColor="#333333"
                GridLines="None" AutoGenerateColumns="False" OnRowCommand="GVLaboratorio_RowCommand" OnDataBound="GVLaboratorio_DataBound" OnSelectedIndexChanged="GVLaboratorio_SelectedIndexChanged">
                <AlternatingRowStyle BackColor="White" />
                <EditRowStyle BackColor="#6B238E" />
                <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                <HeaderStyle BackColor="#236B8E" Font-Bold="True" ForeColor="White" />
                <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />
                <RowStyle BackColor="#CDCDCD" />
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="QtdComputadores" HeaderText="QTD COMPUTADORES" />
                    <asp:BoundField DataField="QtdAlunos" HeaderText="QTD ALUNOS" />
                    <asp:BoundField DataField="Projetor" HeaderText="PROJETOR" />
                    ...
                    <asp:BoundField DataField="SistemaOperacional" HeaderText="SISTEMA OPERACIONAL" />
